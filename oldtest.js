...
describe('Test the people service', () => {
    ...
    //CUSTOMS TESTS
    test('GET /forum succeeds', () => {
        return request(app)
	    .get('/forum')
	    .expect(200);
    });

    test('GET /forum includes First thread!', () => {
        return request(app)
      .get('/forum')
      .expect(/First thread!/);
    });

    test('GET /forum/First thread! succeeds', () => {
        return request(app)
      .get('/forum/First thread!')
      .expect(200);
    });

    test('GET /forum/First thread! returns JSON', () => {
        return request(app)
      .get('/forum/First thread!')
      .expect('Content-type', /json/);
    });
